...
lab.experiment("property - ", () => {
    ...
    lab.test("parse type array", () => {
        ...
        ).to.equal({ type: "array", name: "x", items: { type: "string", format: "binary" } });
